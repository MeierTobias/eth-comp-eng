...
\begin{itemize}
    ...
    \item Typical sizes: $\mathcal{O}(10)$ in small CPUs, $\mathcal{O}(100)$ in larger ones.  % TODO: what does this mean? O(100)=O(10)=O(1), why would a fixed data structure not be constant in size? Do you mean that their size is in the 10s/100s?
\end{itemize}
