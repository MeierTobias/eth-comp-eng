...
\begin{itemize}
    \item \texttt{JAL} is a UJ-type and can jump up to $2^{20}$ 2-byte instructions relative to the PC. \texttt{JAL} uses a signed offset to jump forward and backward.
