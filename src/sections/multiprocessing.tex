...
In jake, \texttt{fork} and \texttt{exec} are combined to \texttt{execv}
\begin{lstlisting}[style=bright_C++]
...
\begin{itemize}
    \item Each process should have illusion of having the entire CPU (kernel should create the illusion of infinite CPUs despite having only one or few)
