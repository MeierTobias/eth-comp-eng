...
\subsubsection{ALUOp}
Given the \texttt{I[6-0]} bits the ALUOp bits get set. The ALUOp bits, in turn, define the \texttt{ALU contr} bits which steer the operation performed by the ALU.\newpar{}
\begin{footnotesize}
    \renewcommand{\arraystretch}{1.2}
    \setlength{\oldtabcolsep}{\tabcolsep}\setlength\tabcolsep{6pt}
