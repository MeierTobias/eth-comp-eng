...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        % TODO: I think for MemRead one could have an "X" in the cases R-format and beq (would still run but waste power). Must it be 0 in the sw case (guess BUS is duplex)?
        % TODO: I think for MemWrite we could never have an "X".
    \end{itemize}
