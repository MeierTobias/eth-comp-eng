...
\lstdefinelanguage[RISC-V]{Assembler}
{
  ...
  morekeywords=[2]{ % sections of our code and other directives
      .align, .ascii, .asciiz, .byte, .data, .double, .extern,              %ChkTeX 26
      .float, .globl, .half, .kdata, .ktext, .set, .space, .text, .word     %ChkTeX 26
    },
  ...
  morestring=[b]",      % mark " as string start/end                        %ChkTeX 18
...
% define custom code colors for highlighting
\def\olivecodecolor{\color{olive}}
\def\cyancodecolor{\color{cyan}}
\def\magentacodecolor{\color{magenta}}
\def\purplecodecolor{\color{purple}}
\def\blackcodecolor{\color{black}}


% custom table defines
\newcommand{\instbit}[1]{\mbox{\scriptsize #1}}
\newcommand{\instbitrange}[2]{~\instbit{#1} \hfill \instbit{#2}~}
% Typewriter font 
\newcolumntype{T}{>{\texttt\bgroup}l<{\egroup}}
% Typewriter font centered
\newcolumntype{Z}{>{\texttt\bgroup}c<{\egroup}}
